...
TagTogglePanel::TagTogglePanel(wxWindow* parent, std::string label)
  ...
  wxButton* b_tag_edit = new wxButton(this, wxID_ANY, "Edit");
  sz_tag_toggle->Add(b_tag_edit, 0, 0, 5);
  wxButton* b_tag_delete = new wxButton(this, wxID_ANY, "X");
  sz_tag_toggle->Add(b_tag_delete, 0, 0, 5);
}
