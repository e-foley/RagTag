...
MainFrame::MainFrame() : wxFrame(nullptr, wxID_ANY, "Flicker Demo", wxDefaultPosition) {
  ...
  wxPanel* p_left_column = new wxPanel(p_main);
  wxStaticBoxSizer* sz_left_column = new wxStaticBoxSizer(wxHORIZONTAL, p_left_column, "Left");
  p_left_column->SetSizer(sz_left_column);
  wxListCtrl* lc_left = new wxListCtrl(sz_left_column->GetStaticBox(), wxID_ANY, wxDefaultPosition,
    wxDefaultSize, wxLC_REPORT);
  lc_left->AppendColumn("First column");
  sz_left_column->Add(lc_left, 1, wxEXPAND);
  sz_main->Add(p_left_column, 1, wxEXPAND);

  wxPanel* p_right_column = new wxPanel(p_main);
  wxStaticBoxSizer* sz_right_column = new wxStaticBoxSizer(wxHORIZONTAL, p_right_column, "Right");
  p_right_column->SetSizer(sz_right_column);
  wxListCtrl* lc_right = new wxListCtrl(sz_right_column->GetStaticBox(), wxID_ANY, wxDefaultPosition,
    wxDefaultSize, wxLC_REPORT);
  lc_right->AppendColumn("First column");
  sz_right_column->Add(lc_right, 1, wxEXPAND);
  sz_main->Add(p_right_column, 1, wxEXPAND);
}
